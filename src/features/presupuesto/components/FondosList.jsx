      ...
      <div className="flex items-start justify-between gap-3">
        <div className="min-w-0 flex-1">
          ...
          <p className="mt-2 text-sm">
            <span className="text-slate-900 font-medium">{formatCurrency(presupuesto)}</span>
            <span className="text-slate-600"> - </span>
            <span className="text-red-600 font-medium">{formatCurrency(gastoTotal)}</span>
            <span className="text-slate-600"> = </span>
            <span className={`font-semibold ${disponible > 0 ? 'text-emerald-600' : 'text-red-700'}`}>
